"""
Demostración Simplificada de Aislamiento Multi-Tenant en TauseStack

Esta versión simplificada muestra las capacidades de aislamiento sin depender 
de todas las dependencias del SDK completo.
"""
...
# Añadir el directorio raíz al path para importar directamente los módulos
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Configurar modo multi-tenant
os.environ["TAUSESTACK_MULTI_TENANT_MODE"] = "true"

# Importar solo los módulos de tenancy e isolation
from tausestack.sdk.tenancy import tenancy, get_current_tenant_id
from tausestack.sdk.isolation import isolation
...
def main():
    ...
    print("🚀 TauseStack v2.0 - Demostración Simplificada de Aislamiento Multi-Tenant")
    print("=" * 75)
    ...
    try:
        ...
        print("  1. Implementar herramientas MCP esenciales")
        print("  2. Integrar aislamiento con el SDK storage existente")
        print("  3. Crear tests automatizados")
        print("  4. Implementar configuración granular por tenant")
