# Dockerfile para TausePro Application (app.tause.pro)
...
# Configurar para aplicación
ENV NEXT_PUBLIC_APP_MODE=app
ENV NEXT_PUBLIC_BASE_URL=https://app.$NEXT_PUBLIC_DOMAIN
